...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top">
    <div class="container">
      <a class="navbar-brand" href="#"><img src="img/Disneylogo.png" width="100"></a>
  ...
  <section id="hero" class="hero text-center p-5 bg-danger-subtle text-sm-start">
    <div class="container">
      <div class="d-sm-flex flex-sm-row-reverse align-items-center">
        <img src="img/mufasa.jpeg" class="img-fluid" width="600">
        <div>
  ...
  <div class="container">
    ...
    <div id="carouselExampleIndicators" class="carousel slide">
      ...
      <div class="carousel-inner">
        <?php
        $hasil = $conn->query($sql); // Jalankan query ulang karena di atas sudah di-loop
        $index = 0;
        while ($row = $hasil->fetch_assoc()) {
          $active = ($index === 0) ? "active" : "";
          echo "<div class='carousel-item {$active}'>
                  <img src='img/{$row["gambar"]}' class=' w-50'>
                </div>";
          $index++;
        }
        ?>
